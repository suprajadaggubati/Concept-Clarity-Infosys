...
function ConditionalNavbar() {
  const location = useLocation()
  const protectedRoutes = ['/dashboard', '/user/dashboard', '/admin/users', '/admin/support', '/user/support', '/profile', '/profile/edit', '/chat']
...
function ConditionalFooter() {
  const location = useLocation()
  const noFooterRoutes = ['/dashboard', '/user/dashboard', '/admin/users', '/admin/support', '/user/support', '/chat']
